...
class EnumDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name_bytes=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, value_or_builder_list=None, value_list=None, options_or_builder=None, reserved_range_or_builder_list=None, reserved_range_count=None, reserved_name_count=None, value_count=None, reserved_range_list=None, reserved_name_list=None, options=None, initialized=None, name=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
