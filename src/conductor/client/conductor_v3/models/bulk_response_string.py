...
class BulkResponseString(object):
    ...
    def __init__(self, bulk_error_results=None, bulk_successful_results=None):  # noqa: E501
        """BulkResponseString - a model defined in Swagger"""  # noqa: E501
    ...
    def bulk_error_results(self):
        """Gets the bulk_error_results of this BulkResponseString.  # noqa: E501


        :return: The bulk_error_results of this BulkResponseString.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def bulk_error_results(self, bulk_error_results):
        """Sets the bulk_error_results of this BulkResponseString.


        :param bulk_error_results: The bulk_error_results of this BulkResponseString.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def bulk_successful_results(self):
        """Gets the bulk_successful_results of this BulkResponseString.  # noqa: E501


        :return: The bulk_successful_results of this BulkResponseString.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def bulk_successful_results(self, bulk_successful_results):
        """Sets the bulk_successful_results of this BulkResponseString.


        :param bulk_successful_results: The bulk_successful_results of this BulkResponseString.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkResponseString, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkResponseString):
            return False
