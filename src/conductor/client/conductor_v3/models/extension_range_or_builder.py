...
class ExtensionRangeOrBuilder(object):
    ...
    def __init__(self, options_or_builder=None, start=None, end=None, options=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
