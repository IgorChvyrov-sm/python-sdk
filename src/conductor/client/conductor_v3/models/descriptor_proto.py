...
class DescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name_bytes=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, extension_count=None, field_count=None, field_list=None, extension_list=None, nested_type_list=None, field_or_builder_list=None, extension_or_builder_list=None, nested_type_or_builder_list=None, enum_type_or_builder_list=None, extension_range_or_builder_list=None, oneof_decl_or_builder_list=None, options_or_builder=None, reserved_range_or_builder_list=None, enum_type_list=None, oneof_decl_list=None, reserved_range_count=None, reserved_name_count=None, reserved_range_list=None, reserved_name_list=None, extension_range_list=None, extension_range_count=None, oneof_decl_count=None, nested_type_count=None, enum_type_count=None, options=None, initialized=None, name=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
