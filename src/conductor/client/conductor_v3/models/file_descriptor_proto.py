...
class FileDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name_bytes=None, public_dependency_list=None, weak_dependency_list=None, weak_dependency_count=None, package_bytes=None, dependency_list=None, message_type_list=None, service_list=None, source_code_info=None, syntax_bytes=None, message_type_or_builder_list=None, service_or_builder_list=None, source_code_info_or_builder=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, extension_count=None, extension_list=None, extension_or_builder_list=None, enum_type_or_builder_list=None, options_or_builder=None, enum_type_list=None, edition=None, dependency_count=None, service_count=None, public_dependency_count=None, message_type_count=None, enum_type_count=None, syntax=None, options=None, initialized=None, name=None, package=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
