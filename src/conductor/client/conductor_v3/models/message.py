...
class Message(object):
    ...
    def __init__(self, parser_for_type=None, serialized_size=None, default_instance_for_type=None, initialized=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, unknown_fields=None):  # noqa: E501
