...
class Any(object):
    ...
    def __init__(self, unknown_fields=None, type_url_bytes=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, initialized=None, type_url=None, value=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
