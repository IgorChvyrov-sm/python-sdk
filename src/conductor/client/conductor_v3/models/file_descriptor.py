...
class FileDescriptor(object):
    ...
    def __init__(self, proto=None, message_types=None, enum_types=None, services=None, extensions=None, dependencies=None, public_dependencies=None, edition=None, edition_name=None, syntax=None, options=None, name=None, package=None, file=None, full_name=None):  # noqa: E501
