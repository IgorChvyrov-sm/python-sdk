...
class OneofDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name_bytes=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, options_or_builder=None, options=None, initialized=None, name=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
