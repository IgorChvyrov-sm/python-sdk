...
class StartWorkflowRequest(object):
    ...
    def __init__(self, name=None, version=None, correlation_id=None, input=None, task_to_domain=None, workflow_def=None, external_input_payload_storage_path=None, priority=None, created_by=None, idempotency_key=None, idempotency_strategy=None):  # noqa: E501
