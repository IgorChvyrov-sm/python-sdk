...
class FieldOptionsOrBuilder(object):
    ...
    def __init__(self, deprecated=None, uninterpreted_option_or_builder_list=None, ctype=None, jstype=None, lazy=None, unverified_lazy=None, weak=None, debug_redact=None, retention=None, targets_list=None, targets_count=None, edition_defaults_or_builder_list=None, features=None, edition_defaults_list=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, packed=None, edition_defaults_count=None, default_instance_for_type=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, unknown_fields=None, initialized=None):  # noqa: E501
