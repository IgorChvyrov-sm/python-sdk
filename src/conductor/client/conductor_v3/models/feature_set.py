...
class FeatureSet(object):
    ...
    def __init__(self, unknown_fields=None, repeated_field_encoding=None, field_presence=None, utf8_validation=None, message_encoding=None, json_format=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, enum_type=None, initialized=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, all_fields_raw=None, memoized_serialized_size=None):  # noqa: E501
