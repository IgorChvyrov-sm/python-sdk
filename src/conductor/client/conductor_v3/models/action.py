...
class Action(object):
    ...
    def __init__(self, action=None, start_workflow=None, complete_task=None, fail_task=None, expand_inline_json=None, terminate_workflow=None, update_workflow_variables=None):  # noqa: E501
