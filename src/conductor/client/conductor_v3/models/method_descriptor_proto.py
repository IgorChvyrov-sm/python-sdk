...
class MethodDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name_bytes=None, input_type_bytes=None, output_type_bytes=None, client_streaming=None, server_streaming=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, options_or_builder=None, output_type=None, input_type=None, options=None, initialized=None, name=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
