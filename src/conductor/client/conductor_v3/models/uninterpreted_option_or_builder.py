...
class UninterpretedOptionOrBuilder(object):
    ...
    def __init__(self, name_or_builder_list=None, identifier_value_bytes=None, positive_int_value=None, negative_int_value=None, aggregate_value_bytes=None, name_list=None, identifier_value=None, aggregate_value=None, double_value=None, string_value=None, name_count=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
