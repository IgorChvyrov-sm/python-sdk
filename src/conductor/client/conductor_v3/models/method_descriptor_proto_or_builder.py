...
class MethodDescriptorProtoOrBuilder(object):
    ...
    def __init__(self, name_bytes=None, input_type_bytes=None, output_type_bytes=None, client_streaming=None, server_streaming=None, options_or_builder=None, output_type=None, input_type=None, options=None, name=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
