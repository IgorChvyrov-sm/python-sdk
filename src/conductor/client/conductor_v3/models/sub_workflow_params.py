...
class SubWorkflowParams(object):
    ...
    def __init__(self, name=None, version=None, task_to_domain=None, idempotency_key=None, idempotency_strategy=None, priority=None, workflow_definition=None):  # noqa: E501
