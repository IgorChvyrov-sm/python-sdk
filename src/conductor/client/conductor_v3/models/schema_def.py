...
class SchemaDef(object):
    ...
    def __init__(self, owner_app=None, create_time=None, update_time=None, created_by=None, updated_by=None, name=None, version=None, type=None, data=None, external_ref=None):  # noqa: E501
