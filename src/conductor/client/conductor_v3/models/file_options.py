...
class FileOptions(object):
    ...
    def __init__(self, unknown_fields=None, deprecated=None, uninterpreted_option_or_builder_list=None, java_package=None, java_package_bytes=None, java_outer_classname=None, java_outer_classname_bytes=None, java_multiple_files=None, java_generate_equals_and_hash=None, cc_generic_services=None, java_generic_services=None, py_generic_services=None, php_generic_services=None, optimize_for=None, go_package=None, go_package_bytes=None, cc_enable_arenas=None, objc_class_prefix=None, objc_class_prefix_bytes=None, csharp_namespace_bytes=None, swift_prefix_bytes=None, php_class_prefix_bytes=None, php_namespace_bytes=None, php_metadata_namespace=None, php_metadata_namespace_bytes=None, ruby_package_bytes=None, csharp_namespace=None, swift_prefix=None, php_class_prefix=None, php_namespace=None, ruby_package=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, features=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, java_string_check_utf8=None, initialized=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, all_fields_raw=None, memoized_serialized_size=None):  # noqa: E501
