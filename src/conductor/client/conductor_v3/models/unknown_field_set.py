...
class UnknownFieldSet(object):
    ...
    def __init__(self, serialized_size_as_message_set=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, initialized=None):  # noqa: E501
