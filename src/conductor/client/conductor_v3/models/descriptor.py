...
class Descriptor(object):
    ...
    def __init__(self, index=None, proto=None, full_name=None, file=None, containing_type=None, nested_types=None, enum_types=None, fields=None, extensions=None, oneofs=None, extendable=None, real_oneofs=None, options=None, name=None):  # noqa: E501
