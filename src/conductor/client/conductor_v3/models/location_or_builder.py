...
class LocationOrBuilder(object):
    ...
    def __init__(self, leading_comments=None, path_list=None, path_count=None, span_list=None, span_count=None, leading_comments_bytes=None, trailing_comments=None, trailing_comments_bytes=None, leading_detached_comments_list=None, leading_detached_comments_count=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
