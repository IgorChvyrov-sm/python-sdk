...
class EnumValueDescriptorProtoOrBuilder(object):
    ...
    def __init__(self, name_bytes=None, options_or_builder=None, options=None, name=None, number=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
