...
class ServiceDescriptorProtoOrBuilder(object):
    ...
    def __init__(self, name_bytes=None, method_count=None, method_or_builder_list=None, method_list=None, options_or_builder=None, options=None, name=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
