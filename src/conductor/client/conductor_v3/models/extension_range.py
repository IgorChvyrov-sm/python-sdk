...
class ExtensionRange(object):
    ...
    def __init__(self, unknown_fields=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, options_or_builder=None, start=None, end=None, options=None, initialized=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, memoized_serialized_size=None):  # noqa: E501
