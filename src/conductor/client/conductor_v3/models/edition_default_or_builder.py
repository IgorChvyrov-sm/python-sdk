...
class EditionDefaultOrBuilder(object):
    ...
    def __init__(self, value_bytes=None, edition=None, value=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, default_instance_for_type=None, unknown_fields=None, initialized=None):  # noqa: E501
