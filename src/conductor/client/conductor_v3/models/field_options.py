...
class FieldOptions(object):
    ...
    def __init__(self, unknown_fields=None, deprecated=None, uninterpreted_option_or_builder_list=None, ctype=None, jstype=None, lazy=None, unverified_lazy=None, weak=None, debug_redact=None, retention=None, targets_list=None, targets_count=None, edition_defaults_or_builder_list=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, features=None, edition_defaults_list=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, packed=None, initialized=None, edition_defaults_count=None, all_fields_raw=None, all_fields=None, initialization_error_string=None, descriptor_for_type=None, memoized_serialized_size=None):  # noqa: E501
