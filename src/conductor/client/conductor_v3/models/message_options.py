...
class MessageOptions(object):
    ...
    def __init__(self, unknown_fields=None, deprecated=None, deprecated_legacy_json_field_conflicts=None, uninterpreted_option_or_builder_list=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, map_entry=None, features=None, no_standard_descriptor_accessor=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, message_set_wire_format=None, initialized=None, initialization_error_string=None, descriptor_for_type=None, all_fields=None, all_fields_raw=None, memoized_serialized_size=None):  # noqa: E501
