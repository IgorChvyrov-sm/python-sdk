...
class EnumOptions(object):
    ...
    def __init__(self, unknown_fields=None, deprecated=None, deprecated_legacy_json_field_conflicts=None, uninterpreted_option_or_builder_list=None, allow_alias=None, default_instance_for_type=None, parser_for_type=None, serialized_size=None, features=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, initialized=None, all_fields_raw=None, all_fields=None, initialization_error_string=None, descriptor_for_type=None, memoized_serialized_size=None):  # noqa: E501
