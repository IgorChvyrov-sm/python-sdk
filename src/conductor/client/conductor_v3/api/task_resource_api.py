...
class TaskResourceApi(object):
    ...
    def get_external_storage_location2(self, path, operation, payload_type, **kwargs):  # noqa: E501
        """Get the external uri where the task payload is to be stored  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_external_storage_location2(path, operation, payload_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_external_storage_location2_with_http_info(path, operation, payload_type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_external_storage_location2_with_http_info(path, operation, payload_type, **kwargs)  # noqa: E501
            return data

    def get_external_storage_location2_with_http_info(self, path, operation, payload_type, **kwargs):  # noqa: E501
        """Get the external uri where the task payload is to be stored  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_external_storage_location2_with_http_info(path, operation, payload_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_external_storage_location2" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('path' not in params or
                params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `get_external_storage_location2`")  # noqa: E501
        # verify the required parameter 'operation' is set
        if ('operation' not in params or
                params['operation'] is None):
            raise ValueError("Missing the required parameter `operation` when calling `get_external_storage_location2`")  # noqa: E501
        # verify the required parameter 'payload_type' is set
        if ('payload_type' not in params or
                params['payload_type'] is None):
            raise ValueError("Missing the required parameter `payload_type` when calling `get_external_storage_location2`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tasks/external-storage-location', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_external_storage_location3(self, path, operation, payload_type, **kwargs):  # noqa: E501
        """Get the external uri where the task payload is to be stored  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_external_storage_location3(path, operation, payload_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_external_storage_location3_with_http_info(path, operation, payload_type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_external_storage_location3_with_http_info(path, operation, payload_type, **kwargs)  # noqa: E501
            return data

    def get_external_storage_location3_with_http_info(self, path, operation, payload_type, **kwargs):  # noqa: E501
        """Get the external uri where the task payload is to be stored  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_external_storage_location3_with_http_info(path, operation, payload_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_external_storage_location3" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'path' is set
        if ('path' not in params or
                params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `get_external_storage_location3`")  # noqa: E501
        # verify the required parameter 'operation' is set
        if ('operation' not in params or
                params['operation'] is None):
            raise ValueError("Missing the required parameter `operation` when calling `get_external_storage_location3`")  # noqa: E501
        # verify the required parameter 'payload_type' is set
        if ('payload_type' not in params or
                params['payload_type'] is None):
            raise ValueError("Missing the required parameter `payload_type` when calling `get_external_storage_location3`")  # noqa: E501
    ...
    def size(self, **kwargs):  # noqa: E501
        """Deprecated. Please use /tasks/queue/size endpoint  # noqa: E501
    ...
    def task_depth(self, task_type, **kwargs):  # noqa: E501
        """Get queue size for a task type.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.task_depth(task_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str task_type: (required)
        :param str domain:
        :param str isolation_group_id:
        :param str execution_namespace:
        :return: int
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.task_depth_with_http_info(task_type, **kwargs)  # noqa: E501
        else:
            (data) = self.task_depth_with_http_info(task_type, **kwargs)  # noqa: E501
            return data

    def task_depth_with_http_info(self, task_type, **kwargs):  # noqa: E501
        """Get queue size for a task type.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.task_depth_with_http_info(task_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['task_type', 'domain', 'isolation_group_id', 'execution_namespace']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('task_type' not in params or
                params['task_type'] is None):
            raise ValueError("Missing the required parameter `task_type` when calling `task_depth`")  # noqa: E501
        ...
        if 'domain' in params:
            query_params.append(('domain', params['domain']))  # noqa: E501
        if 'isolation_group_id' in params:
            query_params.append(('isolationGroupId', params['isolation_group_id']))  # noqa: E501
        if 'execution_namespace' in params:
            query_params.append(('executionNamespace', params['execution_namespace']))  # noqa: E501
    ...
    def update_task_sync(self, body, workflow_id, task_ref_name, status, **kwargs):  # noqa: E501
        """Update a task By Ref Name synchronously and return the updated workflow  # noqa: E501
    ...
    def update_task_sync_with_http_info(self, body, workflow_id, task_ref_name, status, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tasks/{workflowId}/{taskRefName}/{status}/sync', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_task_v2(self, body, **kwargs):  # noqa: E501
        """Update a task and return the next available task to be processed  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_task_v2(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_task_v2_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_task_v2_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_task_v2_with_http_info(self, body, **kwargs):  # noqa: E501
        """Update a task and return the next available task to be processed  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_task_v2_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_task_v2`")  # noqa: E501
