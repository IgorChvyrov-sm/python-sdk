...
class WorkflowResourceApi(object):
    ...
    def get_external_storage_location_with_http_info(self, path, operation, payload_type, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/external-storage-location', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def skip_task_from_workflow(self, workflow_id, task_reference_name, arg2, **kwargs):  # noqa: E501
        """Skips a given task from a current running workflow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.skip_task_from_workflow(workflow_id, task_reference_name, arg2, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str workflow_id: (required)
        :param str task_reference_name: (required)
        :param SkipTaskRequest arg2: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.skip_task_from_workflow_with_http_info(workflow_id, task_reference_name, arg2, **kwargs)  # noqa: E501
        else:
            (data) = self.skip_task_from_workflow_with_http_info(workflow_id, task_reference_name, arg2, **kwargs)  # noqa: E501
            return data

    def skip_task_from_workflow_with_http_info(self, workflow_id, task_reference_name, arg2, **kwargs):  # noqa: E501
        """Skips a given task from a current running workflow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.skip_task_from_workflow_with_http_info(workflow_id, task_reference_name, arg2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['workflow_id', 'task_reference_name', 'arg2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('arg2' not in params or
                params['arg2'] is None):
            raise ValueError("Missing the required parameter `arg2` when calling `skip_task_from_workflow`")  # noqa: E501
    ...
    def terminate_remove(self, workflow_id, **kwargs):  # noqa: E501
        """Terminate workflow execution and remove the workflow from the system  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.terminate_remove(workflow_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.terminate_remove_with_http_info(workflow_id, **kwargs)  # noqa: E501
        else:
            (data) = self.terminate_remove_with_http_info(workflow_id, **kwargs)  # noqa: E501
            return data

    def terminate_remove_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        """Terminate workflow execution and remove the workflow from the system  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.terminate_remove_with_http_info(workflow_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['workflow_id', 'reason', 'archive_workflow']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method terminate_remove" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        if ('workflow_id' not in params or
                params['workflow_id'] is None):
            raise ValueError("Missing the required parameter `workflow_id` when calling `terminate_remove`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/terminate-remove', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
