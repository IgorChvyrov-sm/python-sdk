...
class MetadataResourceApi(object):
    ...
    def get_all_workflows_with_latest_versions(self, **kwargs):  # noqa: E501
        """Returns only the latest version of all workflow definitions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_workflows_with_latest_versions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_workflows_with_latest_versions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_workflows_with_latest_versions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_workflows_with_latest_versions_with_http_info(self, **kwargs):  # noqa: E501
        """Returns only the latest version of all workflow definitions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_workflows_with_latest_versions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_workflows_with_latest_versions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/metadata/workflow/latest-versions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_workflow_names_and_versions(self, **kwargs):  # noqa: E501
        """Returns workflow names and versions only (no definition bodies)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_names_and_versions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workflow_names_and_versions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_workflow_names_and_versions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_workflow_names_and_versions_with_http_info(self, **kwargs):  # noqa: E501
        """Returns workflow names and versions only (no definition bodies)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_names_and_versions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_workflow_names_and_versions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/metadata/workflow/names-and-versions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def register_task_def1(self, body, **kwargs):  # noqa: E501
        """Create new task definition(s)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_task_def1(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.register_task_def1_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.register_task_def1_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def register_task_def1_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create new task definition(s)  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_task_def1_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method register_task_def1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `register_task_def1`")  # noqa: E501
    ...
    def update_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BulkResponseString',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def validate(self, body, **kwargs):  # noqa: E501
        """Validates a new workflow definition  # noqa: E501
    ...
    def validate_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/metadata/workflow/validate', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
