...
class WorkflowBulkResourceApi(object):
    ...
    def delete_workflow_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'archive_workflow']  # noqa: E501
    ...
    def search_workflow(self, body, **kwargs):  # noqa: E501
        """search_workflow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_workflow(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_workflow_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.search_workflow_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def search_workflow_with_http_info(self, body, **kwargs):  # noqa: E501
        """search_workflow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_workflow_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'include_tasks']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `search_workflow`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BulkResponseWorkflowModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def terminate_remove1(self, body, **kwargs):  # noqa: E501
        """terminate_remove1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.terminate_remove1(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.terminate_remove1_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.terminate_remove1_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def terminate_remove1_with_http_info(self, body, **kwargs):  # noqa: E501
        """terminate_remove1  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.terminate_remove1_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'archive_workflow', 'reason']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method terminate_remove1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `terminate_remove1`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/bulk/terminate-remove', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
